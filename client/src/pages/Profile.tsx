...
export default function Profile() {
  ...
  const [theme, setTheme] = useState<ThemeKey>(() => (localStorage.getItem("tradecoin-profile-theme") as ThemeKey) || "dark");
  ...
  function chooseTheme(next: ThemeKey) { setTheme(next); localStorage.setItem("tradecoin-profile-theme", next); }
